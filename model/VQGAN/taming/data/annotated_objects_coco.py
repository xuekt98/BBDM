...
from model.VQGAN.taming.data.annotated_objects_dataset import AnnotatedObjectsDataset
from model.VQGAN.taming.data.helper_types import Annotation, ImageDescription, Category
