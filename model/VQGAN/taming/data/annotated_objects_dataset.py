...
from model.VQGAN.taming.data.conditional_builder.objects_bbox import ObjectsBoundingBoxConditionalBuilder
from model.VQGAN.taming.data.conditional_builder.objects_center_points import ObjectsCenterPointsConditionalBuilder
from model.VQGAN.taming.data.conditional_builder.utils import load_object_from_string
from model.VQGAN.taming.data.helper_types import BoundingBox, CropMethodType, Image, Annotation, SplitType
from model.VQGAN.taming.data.image_transforms import CenterCropReturnCoordinates, RandomCrop1dReturnCoordinates, \
